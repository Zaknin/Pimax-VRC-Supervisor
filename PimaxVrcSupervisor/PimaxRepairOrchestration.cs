...
internal static class PimaxRepairPolicy
{
    ...
    private static PimaxRepairCapability[] BuildCapabilitiesList()
        ...
        [
            ...
            Capability("softwareStackRestartCandidate", "Software-stack restart candidate identification", PimaxRepairCapabilityAvailability.NotApproved, "confirmed", ["Phase 28D2-BV live validation", "Phase 28D2-B2 read-only launch recipe discovery"], "PimaxClient is a coupled group member. A Pimax Play launcher candidate can be modeled, but the full process-group launch and readiness recipe is not live validated.", "The planner must refuse automatic group restart until a stopped-state validation proves the complete recipe."),
            ...
            Capability("processGroupLaunchRecipeModel", "Process-group launch recipe model", PimaxRepairCapabilityAvailability.AvailableWithLimitations, "probable", ["pimax-launch-recipe-v1"], "The backend can report launcher metadata, expected members, readiness criteria, failure criteria, and prohibited side effects.", "The recipe state may reach readyForControlledValidation but remains non-executable until validated."),
