...
internal static class PimaxRepairPolicy
{
    ...
    private static PimaxRepairCapability[] BuildCapabilitiesList()
        ...
        [
            ...
            Capability("softwareStackRestartCandidate", "Software-stack restart candidate identification", PimaxRepairCapabilityAvailability.NotApproved, "confirmed", ["Phase 28D2-BV live validation", "Phase 28D2-BV2 direct-launch rejection", "Phase 28D2-B2 startup-source discovery", "Phase 28D2-B2B creator-chain tooling"], "PimaxClient is a coupled group member and direct process creation is rejected. Normal Start Menu activation is the current candidate, but the safe programmatic equivalent is not validated.", "The planner must refuse automatic group restart until observer-backed startup evidence and separate programmatic validation prove the complete recipe."),
            ...
            Capability("processGroupLaunchRecipeModel", "Process-group launch recipe model", PimaxRepairCapabilityAvailability.AvailableWithLimitations, "probable", ["pimax-launch-recipe-v1", "pimax-startup-sources-v1", "pimax-startup-observation-v1", "pimax-startup-creator-chain-v1"], "The backend can report launcher metadata, startup sources, expected members, creator-chain evidence, readiness criteria, failure criteria, and prohibited side effects.", "The recipe state may reach shellActivationObserved or activationRootIdentified but remains non-executable until a safe programmatic equivalent is validated."),
