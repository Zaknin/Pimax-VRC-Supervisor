...
internal sealed class PimaxRepairPlanner
{
    ...
    private static string SummaryFor(string classification) => classification switch
    {
        ...
        PimaxRepairClassification.SoftwareStackUnavailable => "The full Pimax Play/runtime group is unavailable.\n\nNo safe automatic group launch and readiness recipe has been approved, so automatic recovery is unsupported.",
    ...
    private static string[] DependencyRules(string classification) => classification switch
    {
        ...
        PimaxRepairClassification.SoftwareStackUnavailable => ["capture health", "detect unavailable Pimax Play/runtime group", "require complete approved group launch recipe", "return unsupported automatic recovery"],
    ...
    private static string[] ExpectedOutcomes(string classification) => classification switch
    {
        ...
        PimaxRepairClassification.SoftwareStackUnavailable => ["No executable repair action is available without a complete approved group restart recipe.", "PimaxClient must not be restarted by itself."],
...
internal static class PimaxRepairPolicy
{
    ...
    private static PimaxRepairCapability[] BuildCapabilitiesList()
        ...
        [
            ...
            Capability("softwareStackRestartCandidate", "Software-stack restart candidate identification", PimaxRepairCapabilityAvailability.NotApproved, "confirmed", ["Phase 28D2-BV live validation"], "PimaxClient is a coupled group member and no complete Pimax Play/runtime restart recipe is approved.", "The planner must refuse automatic group restart until a safe launch and readiness recipe is proven."),
    ...
    private static PimaxRepairActionDescriptor[] BuildActionDescriptors()
        ...
        [
            ...
            Action("requireApprovedGroupRestartRecipe", "Require approved Pimax group restart recipe", "softwareStack", false, false, false, false, true, false, 0, ["Pimax Play/runtime group recovery is needed."], ["A complete safe launch, readiness, side-effect, and verification recipe is approved."], ["No complete recipe is approved."], "PimaxClient and runtime members are observe-only until group-level launch and readiness semantics are proven."),
