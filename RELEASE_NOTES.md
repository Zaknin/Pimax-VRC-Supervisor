...
- Adds a Basics > Startup section with mutually exclusive Scheduled Task and SteamVR manifest startup modes.
- Adds the SteamVR dashboard host controls for restarting core face-tracking apps, base-station on/off, and OSC router restart.
